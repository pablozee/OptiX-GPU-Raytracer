...
namespace ParadOPTIx {
        ...
        : model(model)
    {
        ...
        std::cout << "#ParadOPTIx: building SBT ..." << std::endl;
        buildSBT();

        launchParamsBuffer.alloc(sizeof(launchParams));
        std::cout << "#ParadOPTIx: context, module, pipeline, etc, all set up ..." << std::endl;

        std::cout << GDT_TERMINAL_GREEN;
        std::cout << "#ParadOPTIx: Optix 7 Sample fully set up" << std::endl;
    ...
    void Renderer::initOptix()
    {
        ...
        std::cout << GDT_TERMINAL_GREEN
            << "#ParadOPTIx: successfully initialized optix... yay!"
